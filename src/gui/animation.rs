...
pub fn render_rising_particles(ui: &mut Ui, width: f32, height: f32) {
    ...
    const PARTICLES: [(f32, f32, f32, Color32, f32, f32); 8] = [
        ...
        (0.45, 0.35, 5.0, Color32::from_rgb(200, 140, 220), 1.1, 0.125),
        (0.55, 0.3, 4.0, Color32::from_rgb(180, 160, 255), 0.9, 0.25),
        (0.50, 0.45, 5.5, Color32::from_rgb(240, 170, 210), 1.25, 0.375),
        (0.40, 0.5, 4.8, Color32::from_rgb(170, 200, 230), 0.8, 0.5),
        (0.60, 0.4, 4.2, Color32::from_rgb(220, 180, 200), 1.15, 0.625),
        (0.48, 0.35, 5.0, Color32::from_rgb(190, 150, 240), 0.85, 0.75),
